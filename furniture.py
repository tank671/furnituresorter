...
path = Path("/tmp")
classes = ['bookshelf', 'console', 'door', 'railing', 'table']
...
learner.model.load_state_dict(
        torch.load("furniture-weights.pth", map_location="cpu")
)
...
def form(request):
    return HTMLResponse(
            """
            <h1>Railing Or Not!</h1>
            <p>Find out if you have a picture of a railing.  Or of some other type of metal work.  Upload image or specify URL.</p><br>
